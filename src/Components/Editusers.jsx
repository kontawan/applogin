...
import {Link} from 'react-router-dom';
 ...
 class  Editusers extends Component {
    ...
    users_follname_Change = (event) => {
        let data = this.state.edituser;
       data.users_follname  = event.target.value;
       this.setState({
           edituser:data
       });
    }
    ...
    users_email_Change = (event) => {
     ...
     submitEdituser = async (event) => {
      ...
      this.state.match.params.users_name_old = this.props.match.params.users_name;

        let result = await axios.post('http://locahost/netlogapi/users.php',this.state.edituser);
     ...
     render() { 
        ...
        <div className="input-group mb-3">
            <div className="input-group-prepend">
              ...
              <hr />
              <input type="text" id="users_name" name="users_name" placeholder="Fullname" value={ this.state.edituser.users_fullname}
        ...
        <div className="input-group mb-3">
            <div className="input-group-prepend">
              ...
              <hr />
              <input type="text" id="users_phone" name="users_name" placeholder="Phone" value={ this.state.edituser.users_phone}
        ...
        <div className="input-group mb-3">
            <div className="input-group-prepend">
              ...
              <hr />
              <input type="text" id="users_email" name="users_name" placeholder="Email" value={ this.state.edituser.users_email}
              onChange ={this.users_email_Change} className="form-control form-control-lg" />
              
        </div>
        <div className="row">
         <input type="submit" id="save_bt" name="save_bt" value="Save" 
         className="btn btn-success  btn-lg col-md5 mx-auto" 
          />

                  <input type="submit" id="cancal_bt" name="cancal_bt" value="Cancal" 
                  className="btn btn-secondary  btn-lg col-md5 mx-auto" 
                   />
                   </div>
      </form>
      </div>
